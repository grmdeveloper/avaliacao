...
// Product version
define(PROJECT_NAMESPACE . "PRODUCT_VERSION", "12.0.3");
...
define(PROJECT_NAMESPACE . "RANDOM_KEY", 'TQk6J70v4YcxJ9HG'); // Random key for encryption
...
$PROJECT_ID = "{53975D99-68EC-47DF-8A09-F92A43852C9C}"; // Project ID (GUID)
$RELATED_PROJECT_ID = "";
...
$CONNECTIONS["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "192.168.0.2", "port" => 3306, "user" => "root", "pass" => "trewq", "db" => "avaliacoes", "qs" => "`", "qe" => "`");
...
define(PROJECT_NAMESPACE . "ADMIN_PASSWORD", "master"); // Administrator password
