<?php 
	...
	echo "<h1 style='text-align:center;margin-top:10%; width:60%; color:#431887;'>Obrigado por usar nosso sistema de avaliação, nos ajudando a melhorar o serviço público prestado!</h1>";
